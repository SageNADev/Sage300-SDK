...
::
::          * Remove folders and files from the folder:
::
::               'SDK\src\wizards\Templates\CustomizationWizard\Web\' 
::
::            Note: It does not remove all folders and files, just
::                  the folders (and files) defined in the 
::                  psDeleteWebFiles.ps1 script file.
::
::          * Copy the Columbus-Web artifacts to folder:
:: 
::               'SDK\src\wizards\Templates\CustomizationWizard\Web\' 
::
:: Usage Example:
