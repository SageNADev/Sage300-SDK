...
var ISV1OrderEntryCustomUI = ISV1OrderEntryCustomUI || {};
var customViewModel;

ISV1OrderEntryCustomUI = {
    ...
    init: function () {
        ...
        ISV1OrderEntryCustomUI.initIntercept();
        ISV1OrderEntryCustomUI.initAjaxCallIntercept();
        ISV1OrderEntryCustomUI.initButtons();
        ISV1OrderEntryCustomUI.initFinders();
        ISV1OrderEntryCustomUI.initTextbox();
        ISV1OrderEntryCustomUI.initNumericTextBox();
        ISV1OrderEntryCustomUI.initDropDownList();
        ISV1OrderEntryCustomUI.initDatePicker();
        ISV1OrderEntryCustomUI.initCheckBoxes();
        ISV1OrderEntryCustomUI.initGrid();
        ISV1OrderEntryCustomUI.initOtherControls();
    ...
    initAjaxCallIntercept: function () {
        ...
        $(document).ajaxSuccess(function (event, xhr, settings) {
            if (settings.url.indexOf("/OE/OrderEntry/GetDetails") > -1) {
                ...
                ISV1OrderEntryCustomUI.orderNumber = data.model.OrderNumber;
                if (data.model.OrderNumber && data.model.OrderNumber !== "*** NEW ***") {
                    ...
                    for (var i = 0; i < gridData.length; i++) {
                        ISV1OrderEntryCustomUI.total[0] += gridData[i].ExtendedPrice;
                        ISV1OrderEntryCustomUI.total[1] += gridData[i].DiscountedExtendedAmount;
                        ISV1OrderEntryCustomUI.total[2] += gridData[i].ExtendedOrderCost;
                    }
                    $("#txtCustomCTotalCost").val(ISV1OrderEntryCustomUI.total[0]);
                    var comment = "Total Cost for " + data.model.OrderNumber + " is " + ISV1OrderEntryCustomUI.total[0];
                ...
                if (data.model.OrderNumber && data.model.OrderNumber !== "*** NEW ***") {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ISV1OrderEntryCustomUICallback.loadCustomOrder(data);
                        },
                        error: function () {
                        }
                    });
    ...
    initButtons: function () {
        $("#btnFromSage300").bind('click', function () {
            ...
            sg.utls.ajaxPost(url, { currencyCode: "CAD" }, ISV1OrderEntryCustomUICallback.getCustomInfo);
        });
    },
    ...
    initDropDownList: function () {
        ...
        $("#dropdownOECostTypeId").kendoDropDownList({
            ...
            change: function (e) {
                ...
                $("#txtCustomCTotalCost").val(ISV1OrderEntryCustomUI.total[idx]);
            }
        });
    ...
    initFinders: function () {
        sg.finderHelper.setFinder("btnCustomCurrencyFinder", sg.finder.TaxCurrencyFinder, ISV1OrderEntryCustomUICallback.currencyCode, null, "Custom Currency Finder", sg.finderHelper.createDefaultFunction("txtCustomCurrency", "CurrencyCodeId", sg.finderOperator.StartsWith), null, true);
        sg.finderHelper.setFinder("btnCustomCurrencyFinder1", sg.finder.TaxCurrencyFinder, ISV1OrderEntryCustomUICallback.currencyCode1, null, "Custom Currency Finder", sg.finderHelper.createDefaultFunction("txtCustomCurrency1", "CurrencyCodeId", sg.finderOperator.StartsWith), null, true);
...
var ISV1OrderEntryCustomUICallback = {
    ...
    loadCustomOrder: function(data) {
        ...
        customViewModel = ko.mapping.fromJS(data);
